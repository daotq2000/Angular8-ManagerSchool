...
import { HelloPolyComponent } from './hello-poly/hello-poly.component';
...
const layout = [
  ...
  , children: [
     {path:'dashboard', component:SchoolComponentComponent},
      ...
      {path: 'poly', component: HelloPolyComponent}
  ]
...
@NgModule({
  ...
  declarations: [ AppComponent, HelloComponent,  ClassComponentComponent, SchoolComponentComponent, DashboardComponent, SchoolFormComponent, HeaderComponent, FooterComponent, TopbarComponent, LoginComponent, IndexComponent, ClassFormComponent, HelloPolyComponent, TestComponent,  ],
